      ...
      <div class="full-width-split__inner">
        ...
        <?php
          ...
          $home_blogs = new WP_Query(array(
            'posts_per_page' => 2,
            'post_type' => 'post', //default post_type is 'post'
          ));
        ...
        <?php 
          ...
          // make a habit, after running custom queries (after the end of while-loop)
          // run this command below to Restore original Post Data
          wp_reset_postdata();
        ?>
        
        <p class="t-center no-margin"><a href="<?php 
          echo site_url('blog');
          // echo get_post_type_archive_link('post'); //here's another way to open the archive, but in this case, use site_url() is better
